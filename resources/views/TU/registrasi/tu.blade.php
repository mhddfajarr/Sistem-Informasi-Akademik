    ...
    <div class="row">
      <div class="col-md-12 col-sm-12  ">
        <div class="x_panel">
            <div class="x_title">
                <span>
                    <h3 style="color: black;">Registrasi Tata Usaha</h3>
                </span>
            </div>
            <div class="x_content">
                ...
                @endif
                <form action="/registrasi/TU" method="post" class="form-horizontal form-label-left">
                    @csrf
                    ...
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="nip">NIP <span class="red">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
