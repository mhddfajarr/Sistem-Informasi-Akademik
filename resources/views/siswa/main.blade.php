          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                ...
                @if(Auth::guard('siswa')->user()->foto =='default.png')
                <img src="../img/default.png" alt="..." class="img-circle profile_img">
                @else
                <img src="{{ asset('storage/' . Auth::guard('siswa')->user()->foto) }}" alt="..." class="img-circle profile_img">
                @endif
              </div>
            ...
            <div id="sidebar-menu" style="margin-top:20px;" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="/S_profile"><i class="fa fa-user"></i> Profile </a>
                  </li>
                  <li><a href="/S_jadwal"><i class="fa fa-calendar"></i>Jadwal</a>
                  </li>
                  </li>
                  <li><a href="/S_dataGuru"><i class="fa fa-table"></i> Data Guru </a>
                  </li>
                  <li><a href="/S_kelasNilai"><i class="fa fa-file-excel-o"></i>Nilai</a>
                  </li>
                  <li><a href="/S_materi"><i class="fa fa-file-excel-o"></i>Materi</a>
                  </li>
