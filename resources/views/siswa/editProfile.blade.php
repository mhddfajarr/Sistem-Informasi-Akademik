    ...
    <div class="row">
      <div class="col-md-12 col-sm-12  ">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form action="/S_editProfile" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                    @csrf
                    @method('patch')
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 ">nama</label>
						<div class="col-md-5 col-sm-9 ">
							<input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ $data_login->nama_siswa }}">
                            @error('nama')
                    ...
                    <div class="item form-group">
						...
						<div class="col-md-5 col-sm-9 ">
							<input type="text" class="form-control @error('nip') is-invalid @enderror" id="nip" name="nip" value="{{ $data_login->nip }}" >
                            @error('nip')
                            <div class="invalid-feedback alert-dismissible">
                                {{ $message }}
                             </div>
                    ...
                    <div class="item form-group">
						...
						<div class="col-md-5 col-sm-9 ">
							<input type="text" class="form-control" name="nama_ayah" id="nama_ayah" value="{{ $data_login->nama_ayah }}">
						</div>
                    </div>
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 ">Nama Ibu</label>
						<div class="col-md-5 col-sm-9 ">
							<input type="text" class="form-control" name="nama_ibu" id="nama_ibu" value="{{ $data_login->nama_ibu }}">
						</div>
                    </div>
                    <div class="item form-group">
