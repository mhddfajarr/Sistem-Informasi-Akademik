      ...
      <div class="col-md-12 col-sm-12  ">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                @endif
                <div class="col-12">
                    <a href="/exportNilai/{{ $kelas->id }}" class="btn btn-success btn-sm" style="float: right">Export Excel</a>
                </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($siswa as $siswa)
                            <tr>
                                ...
                                @endforeach
                                <td>
                                    <a href="/inputNilai/{{ $siswa->id }}"><span class="badge badge-info">input</span></a>
                                    {{-- <a href="/editNilai/{{ $siswa->id }}"><span class="badge badge-primary">Edit</span></a> --}}
                                    <form action="/hapusNilai/{{ $siswa->id }} " method="POST" class="d-inline">
                                        @method('DELETE')
                                        @csrf
